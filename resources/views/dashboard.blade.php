...
<x-app-layout>
    <x-slot name="headerTitle">
        <x-bread-link text="الصفحة الرئيسية"></x-bread-link>
    </x-slot>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-12">
            <div class="col-2 mx-auto text-center">
                <div style="width:250px mx-auto">
                    <x-application-logo></x-application-logo>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-8 col-lg-6 mx-auto mt-3">
            <div class="shadow-lg rounded-lg bg-white p-5 text-center">
                @if ($settings)
                    {{ $settings->welcome }}
                @else
                    You're Welcome in our application!
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="row mt-4">
        <div class="col-12 col-md-6 col-lg-3">
            <div class="info-box justify-content-between">
                <div class="info-box-content text-right">
                    <span class="info-box-text">عدد الدورات</span>
        ...
        <!-- /.col -->
        <div class="col-12 col-md-6 col-lg-3">
            <div class="info-box mb-3 justify-content-between">
        ...
        <div class="col-12 col-md-6  col-lg-3">
            <div class="info-box mb-3 justify-content-between">
                ...
                <div class="info-box-content text-right">
                    <span class="info-box-text">عدد المعلمين</span>
        ...
        <div class="col-12 col-md-6  col-lg-3">
            <div class="info-box mb-3 justify-content-between">
                ...
                <div class="info-box-content text-right">
                    <span class="info-box-text">عدد جميع المستخدمين</span>
        ...
        <div class=" {{-- col-md-8 col-lg-6 mx-auto --}}">
            <div class="d-flex">
                @can(User::P_ADD_EVENT)
                    <a type="button" href="" class="btn btn-info btn-sm text-white btnCreateEventModal mt-4 mb-3">
            ...
            <div class="table-responsive">
                <table id="usersTable" class="table table-hover text-right bg-white px-3">
